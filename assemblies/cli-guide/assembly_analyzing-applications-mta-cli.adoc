...
The {ProductShortName} CLI supports running source code and binary analysis by using the `analyzer-lsp` tool. This tool evaluates rules by using language providers.
