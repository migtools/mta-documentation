...
To connect the {ocp-short} AI platform to a large language model (LLM), first, upload your LLM to a data source.
...
Next, you must configure a data connection to the bucket and deploy the LLM.
