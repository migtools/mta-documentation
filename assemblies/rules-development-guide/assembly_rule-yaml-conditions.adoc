...
ifdef::context[:parent-context-of-provider-conditions: {context}]
...
ifdef::context[]
[id="provider-conditions_{context}"]
endif::[]
= Providers and rule conditions 

:context: provider-conditions
...
ifdef::parent-context-of-provider-conditions[:context: {parent-context-of-provider-conditions}]
ifndef::parent-context-of-provider-conditions[:!context:]
