...
* You installed the {ProductShortName} UI. For more information, see link:https://docs.redhat.com/en/documentation/migration_toolkit_for_applications/8.0/html/install-guide/installing-mta-ui_installing-mta-title[Installing the Migration Toolkit for Applications user interface].
