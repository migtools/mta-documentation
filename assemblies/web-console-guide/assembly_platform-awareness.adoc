...
ifdef::context[:parent-context-of-platform-awareness-v1: {context}]

:_mod-docs-content-type: ASSEMBLY

ifndef::context[]
[id="platform-awareness-v1"]
endif::[]
ifdef::context[]
[id="platform-awareness-v1_{context}"]
endif::[]
= Platform awareness in {ProductShortName} {WebName}

:context: platform-awareness-v1
...
You can connect applications to source platforms in two ways: 
...
ifdef::parent-context-of-platform-awareness-v1[:context: {parent-context-of-platform-awareness-v1}]
ifndef::parent-context-of-platform-awareness-v1[:!context:]