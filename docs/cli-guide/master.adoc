...
You can run the CLI against one or more applications. The procedure for running the CLI against one application varies slightly from the procedure for running CLI against more than one application.

// Run the CLI
include::topics/mta-cli-run-single-app.adoc[leveloffset=+2]
include::topics/mta-cli-run-multiple-apps.adoc[leveloffset=+2]
