...
include::assemblies/developer-lightspeed-guide/assembly_llm-proxy-interaction-monitoring.adoc[leveloffset=+1]

include::assemblies/developer-lightspeed-guide/assembly_emergency-llm-proxy-shutdown.adoc[leveloffset=+1]
