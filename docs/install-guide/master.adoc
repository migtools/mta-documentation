...
[role="_abstract"]
Use this guide to install the {ProductName} user interface (UI) and command-line interface (CLI) on Red Hat OpenShift or your local system. You need these components to assess and migrate applications.
