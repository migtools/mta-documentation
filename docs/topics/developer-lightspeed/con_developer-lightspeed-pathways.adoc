...
The configuration workflow that you complete to use {mta-dl-plugin} depends on:

* How you prefer to connect the {mta-dl-plugin} extension to the LLM 
* If you want to use Retrieval Augmented Generation (RAG) or Agent AI for request resolutions. 
