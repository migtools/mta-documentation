...
.. Connect to the {ProductShortName} Hub and run an analysis by using a profile downloaded from the Hub. See link:{mta-URL}/configuring_and_using_the_visual_studio_code_extension_for_mta/analyzing-application-profiles_configuring-using-vs-code-plugin[Running an application analysis by using a profile].
