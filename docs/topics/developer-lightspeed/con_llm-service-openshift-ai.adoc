...
.Related links
* xref:llm-provider-settings_{context}[Configuring LLM provider settings] to configure the base URL and the LLM API key in the {mta-dl-plugin} Visual Studio Code extension.