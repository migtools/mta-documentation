...
See xref:ref_llm-provider-configurations_context[Configuring LLM provider settings] to configure the base URL and the LLM API key in the {mta-dl-plugin} VS Code extension.