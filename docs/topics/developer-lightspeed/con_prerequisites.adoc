...
You must enter the provider value and model name in the Tackle CR to enable generative AI configuration in the {ProductShortName} Visual Studio Code plugin. 
+
