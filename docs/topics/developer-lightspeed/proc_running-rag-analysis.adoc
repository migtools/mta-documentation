...
To resolve the identified issues, see xref:proc_apply-rag-resolution_mta-developer-lightspeed[Applying resolutions] after generating suggestions to change code.