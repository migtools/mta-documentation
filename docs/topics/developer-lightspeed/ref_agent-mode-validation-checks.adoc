...
[role="_abstract"]
To understand how the system ensures code validity, review the verification checks that {mta-dl-plugin} performs in the agent mode. 
