...
[NOTE]
====
You can use the link:https://aws.amazon.com/cli/[AWS CLI] to verify that you have command line access to AWS services before you proceed with the `provider-settings` configurations.
====
