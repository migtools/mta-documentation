...
* Linux installation requires a full Java JDK installed, including the `java-<JDK-version>-devel` package, as having only the Java Runtime (JRE) installed causes issues during analysis.
+
