...
== {ProductName} Operator in a Red Hat OpenShift Local environment
...
[id="mta-7-os-requirements-on-openshift_local_{context}"]
=== Operating system requirements

Red Hat OpenShift Local requires the following minimum version of a supported operating system:

[id="mta-7-windows-requirements-on-openshift_local_{context}"]
...
[id="mta-7-macos-requirements-on-openshift_local_{context}"]
...
[id="mta-7-linux-requirements-on-openshift_local_{context}"]
...
[id="mta-7-intalling-ocp_local_{context}"]
== Installing the {ProductName} Operator in
//a Red Hat OpenShift Local environment
