...
. Run the following command to list all the languages in an application. 
The listed langauages can have a supported provider or require a custom rule set for analysis.

+
[source,terminal,subs="attributes+"]
----
$ ./{mta-cli} analyze --input <path_to_input> --list-languages
----
+
