...
[id="cli-known-issues_{context}"]
= The {ProductShortName} {CLINameTitle} known issues
...
This error occurs because Red Hat Enterprise Linux 9 or Universal Base Image 9 container images must be run on a CPU architecture that supports `x86-64-v2`.
