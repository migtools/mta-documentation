...
+
NOTE: See xref:discover-values-deployment_generating-assets[The deployment manifest input values] for information about the values that {ProductShortName} takes as inputs to generate the deployment manifest.
