...
. Under the File tab, click a file to display the incidents that triggered the issue.
...
* xref:accessing-analysis-report_reviewing-analysis-reports[Accessing an analysis report]
