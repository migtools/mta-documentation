...
NOTE: You can analyze Gradle projects that have Kotlin scripts for build files by using {ProductShortName} version 8.1.0. For example, `build.gradle.kts` and `settings.gradle.kts`.
