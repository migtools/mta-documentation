...
* You installed the {ProductShortName} CLI. For more information, see link:https://docs.redhat.com/en/documentation/migration_toolkit_for_applications/8.0/html/installing-mta-title/installing-mta-cli_installing-mta-title#installing-cli-zip_installing-mta-cli[Installing the CLI by using a .zip file].
...
* link:https://docs.redhat.com/en/documentation/migration_toolkit_for_applications/8.0/html/installing-mta-title/installing-mta-cli_installing-mta-title#installing-cli-zip_installing-mta-cli[Installing the CLI by using a .zip file]
