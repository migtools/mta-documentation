...
[role="_abstract"]
The {ProductFullName} command-line interface (CLI) provides `OpenRewrite` recipes that define specific code transformation logic. Check the following table to view the available recipes that you can use for transforming application source code.
