...
* Try {ProductName} on your application. Report any issues you meet. {ProductShortName} uses Jira as its issue tracking system. If you encounter an issue when using {ProductShortName}, submit a link:{JiraMTAURL}[Jira issue].
