...
[role="_abstract"]
You must have the Java Development Kit (JDK) installed on your system before installing the Eclipse integrated development environment (IDE). {ProductFirstRef} supports the following JDKs: 		
