...
* *Enhanced role-based access control (RBAC)* powered by Red Hat build of Keycloak (RHBK) to define the following personas:
** Administrator
** Architect
** Migrator
...
* link:https://access.redhat.com/products/red-hat-build-of-keycloak[Red Hat build of Keycloak]