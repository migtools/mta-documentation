...
* 2 RWO persistent volumes (PVs) used by different components.
pass:[<!-- vale RedHat.Spelling = YES -->] For more information, see link:{mta-URL}/installing_the_migration_toolkit_for_applications/index#persistent-volume-requirements_installing-mta-ui[Persistent volume requirements].
