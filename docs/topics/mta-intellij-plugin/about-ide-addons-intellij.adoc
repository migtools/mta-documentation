...
The {ProductShortName} {AddonType} analyzes your projects by using customizable rulesets, marks issues in the source code, provides guidance to fix the issues, and offers automatic code replacement, if possible.
