...
** *Report* opens the {ProductShortName} report, which describes any issues you need to address before you migrate or modernize your application. For more information, see link:{ProductDocUserGuideURL}#reviewing-analysis-reports_cli-guide[Reviewing the reports] in the _{UserCLIBookName}_.
