...
+
If you select *Mark as Complete*, the Complete indicator (image:intellij-idea-ok.png[Complete], a green check mark) is displayed by the hint, replacing the error indicator.
