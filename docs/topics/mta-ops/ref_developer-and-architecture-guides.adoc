...
* Development guides (`docs/development/`): Contains dedicated documents for local environment setup, unit and E2E testing conventions, and end-to-end pipeline architecture.
