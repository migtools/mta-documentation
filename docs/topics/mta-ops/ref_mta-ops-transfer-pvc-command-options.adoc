...
| 
| Requested storage capacity for the destination PVC (for example, `10Gi`).
...
| `--encrypt`
| 
| Enables client-side 256-bit NaCl SecretBox encryption for indirect cloud storage transfers.
