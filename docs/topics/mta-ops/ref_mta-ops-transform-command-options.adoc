...
= The mta-ops transform command options
...
| `--skip-plugin`s | | A comma-separated list of built-in plugins to skip, such as OpenShiftPlugin.
| `--optional-flags` | | Additional arguments or parameters passed to the transformation plugins.
