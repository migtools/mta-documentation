...
Multi-stage agents run a pre-configured sequence of stages or a pipeline that includes an assess (issues), remediate (issues), verify (resolved issues), and report loop.
