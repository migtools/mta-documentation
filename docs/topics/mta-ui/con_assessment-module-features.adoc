...
Archetypes::
You can group applications with similar characteristics into archetypes. Use archetypes to assess several applications at once. Each archetype has a shared taxonomy of tags, stakeholders, and stakeholder groups. All applications inherit assessment and review from their assigned archetypes.
