...
[role="_abstract"]
To determine which specific lines in an application you must modify before migrating or modernizing the application, configure and run an application analysis for this application in the {ProductFullName} user interface (UI). 
