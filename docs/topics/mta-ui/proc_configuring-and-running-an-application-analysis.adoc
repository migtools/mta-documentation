...
= Configuring and running an application analysis manually
...
. Select *Manual selection* in the *Mode* section for the analysis. You can provide a unique configuration for an analysis.
...
* Select *Save analysis options as an analysis profile*. You can save the current configuration as an analysis profile by providing a unique name. The configuration is saved in the *Analysis Profiles* menu.
