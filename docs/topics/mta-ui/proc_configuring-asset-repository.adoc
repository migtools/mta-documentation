...
[role="_abstract"]
Configure an asset repository for the {ProductFullName} user interface (UI) to publish the generated assets to. If you do not configure the asset repository, the application repository is considered the default location for publishing the generated assets.
