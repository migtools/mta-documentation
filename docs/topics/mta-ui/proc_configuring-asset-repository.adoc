...
[role="_abstract"]
Configure an asset repository in the {ProductFullName} user interface (UI) to publish generated assets. If you do not configure the asset repository, the application repository is considered the default location for publishing the generated assets.
...
. Click the edit icon (image:icon_edit.png[edit icon]) to update an imported application.
