...
* For Jira Cloud and a private Jira server or data center, use the *Basic authentication* credential type. 		
...
. In the *Type* list, select *Basic authentication (Jira)* or *Bearer Token (Jira)*:
+
* If you selected *Basic authentication (Jira)*, complete the following steps:
