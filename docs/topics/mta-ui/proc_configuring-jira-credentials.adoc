...
[role="_abstract"]
To define a Jira instance in {ProductShortName} and establish a connection to that instance, create a {ProductFullName} credential to authenticate to the Jira instance's API.
...
.. Click *Save*.
+
The new credential is displayed on the *Credentials* page.
