...
[role="_abstract"]
To provide the {ProductFullName} with secure access to your private Maven repositories, configure authentication credentials in the user interface. Adding these profiles ensures analysis tasks can automatically retrieve the required data.

To access Maven repositories, you can configure new Maven credentials in the `settings.xml` settings file. 
