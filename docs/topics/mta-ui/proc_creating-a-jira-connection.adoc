...
[NOTE]
====
If you selected *Jira Cloud* as an instance type, only *Basic authentication* credentials are displayed in the list.

If you selected *Jira Server/Data center* as an instance type, both *Basic authentication* and *Token Bearer* credentials are displayed. 
