...
[role="_abstract"]
After you configure a source platform, discover and import one or more applications to the {ProductShortName} application inventory in the *Migration* view.
