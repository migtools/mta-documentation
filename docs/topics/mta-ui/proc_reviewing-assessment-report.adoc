...
To identify migration risks and estimate modernization effort, review the assessment report in the {ProductFullName} user interface (UI). You can use this report to view aggregated data from multiple application questionnaires for different applications.
