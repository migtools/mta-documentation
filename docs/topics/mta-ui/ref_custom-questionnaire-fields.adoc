...
Every custom questionnaire field marked as _required_ is mandatory. If you do not define such fields, the YAML syntax will not validate on upload. Each subsection of the field defines a new structure or object in YAML, for example:
