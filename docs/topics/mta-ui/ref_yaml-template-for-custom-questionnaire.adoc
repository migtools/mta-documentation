...
[role="_abstract"]
To correctly format your assessment data for the use in the {ProductFullName} user interface (UI), use the following YAML template for custom questionnaires.
...
* xref:custom-questionnaire-fields_mta-custom-questionnaire[The custom questionnaire fields]
