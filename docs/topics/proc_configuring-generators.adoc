...
+ 
The values you enter overrides the value of in the discovery manifest when the generator generates the assets. 
...
+
NOTE: During template instantiation, parameter takes precedence over values and values takes precedence over the configurations present in the discovery manifest.
. Click *Save*.
