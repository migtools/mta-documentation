...
Workaround: you must restart the analyzer process by clicking the Start/Stop button after making a configuration change.
link:[https://issues.redhat.com/browse/MTA-6128([MTA-6128])](https://issues.redhat.com/browse/MTA-6128[MTA-6128)
