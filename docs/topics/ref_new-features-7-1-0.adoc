...
In {ProductFullName} 7.1.0, you can use {ProductShortName} to analyze Windows-only .NET framework applications to aid migration from version 4.12 or later to multi-platform .NET 8.0 running on OpenShift Container platform.
