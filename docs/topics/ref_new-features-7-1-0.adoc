...
Issues that do not impact the migration but contain useful information about the technologies used in the application and their usage in the code are categorized as Insights. Issues do not have an effort and category assigned, but might have a message and tag. You can view Insights in the Static report under the Insights tab and in the analysis output under the Insights section. 
