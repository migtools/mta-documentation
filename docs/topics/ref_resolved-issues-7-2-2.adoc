...
Previously in {ProductShortName} CLI, analyses of an application with a private repository source control, generated varying effort. This issue has been resolved in {ProductShortName} 7.2.2. link:https://issues.redhat.com/browse/MTA-2984[(MTA-2984)] 
