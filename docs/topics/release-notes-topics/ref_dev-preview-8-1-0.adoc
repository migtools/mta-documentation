...
[role="_abstract"]
You can use this list to review all Developer Preview features available in {ProductFullName} 8.1.0.
...
The {ProductFullName} Visual Studio Code extension consists of an analyzer Remote Procedure Call (RPC) binary that runs an analysis for the following extensions:
