...
When you analyzed Java binary applications, {ProductShortName} incorrectly classified some open-source dependencies as internal dependencies. With this version, this issue if fixed. This leads to {ProductShortName} classifying embedded open source dependencies correctly after a source+dependency binary analysis. link:https://issues.redhat.com/browse/MTA-6357[MTA-6357]
