...
[role="_abstract"]
Migration toolkit for applications ({ProductShortName}) version 8.0.0 provides the following fixed issues and other problems that have a significant impact. 
