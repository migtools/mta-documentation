...
[role="_abstract"]
Review the following newly identified and previously known issues in {ProductFirstRef} ({ProductShortName}) version 8.0.1. All future release notes list a known issue until resolved, at which point it appears as a fixed issue.
