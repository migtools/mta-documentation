...
[role="_abstract"]
 Understand how newly identified and previously known issues might affect your use of {ProductFirstRef} ({ProductShortName}) version 8.0.0, and how to work around them.
