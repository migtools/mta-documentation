...
A new Visual Studio Code IDE plug-in for application analysis::

With this enhancement, you can use a new Visual Studio Code IDE plug-in that has the following features:
