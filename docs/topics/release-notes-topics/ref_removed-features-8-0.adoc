...
[role="_abstract"]
You can use this list to review all features removed in {ProductFullName} 8.0.0. All removed features were deprecated in earlier releases and are no longer supported. 
