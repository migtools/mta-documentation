...
[role="_abstract"]
This section provides a list of all features removed in {ProductFullName} 8.0.0. All removed features were deprecated in earlier releases and are no longer supported. 
