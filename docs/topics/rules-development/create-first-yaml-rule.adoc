...
[role="_abstract"]You can create and test your first {ProductShortName} YAML-based rule by completing the following procedure. This assumes that you have already installed {ProductShortName}. See link:{ProductDocUserGuideURL}/index#installing_and_running_the_cli[Installing and running the CLI] in the…
