...
You can use the following custom rule to check if {ProductShortName} triggers an incident when it detects the `v1beta1.CustomResourceDefinition` in the`go` file.
