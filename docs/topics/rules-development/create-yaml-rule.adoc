...
+
The provider condition is used to define a search query for a specific language provider. Provider condition also specifies the capability of the provider used to complete the search query.
+
