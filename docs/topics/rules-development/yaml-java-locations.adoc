...
----
|`CLASS` (declaration)|Matches against a given method declaration. You can couple it with an annotation match. See xref:yaml-annotation-inspection_java-conditions-capabilities[Annotation inspection].
