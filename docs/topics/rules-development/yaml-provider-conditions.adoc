...
|location
|No
|Source code location (see xref:yaml-java-locations_{context}[Java locations])

|annotated
|No
|Additional query to inspect annotations (see xref:yaml-annotation-inspection_{context}[Annotation inspection]).
