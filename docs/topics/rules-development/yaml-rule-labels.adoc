...
You can omit the value of a label. In that case, {ProductShortName} treats it as an empty value:
...
[subs="+quotes"]
----
--label-selector="key1=_<val1>_ && key2"
----
...
[subs="+quotes"]
----
--label-selector="(key1=_<val1>_ || key2=_<val2>_) && !_<val3>_"
----
