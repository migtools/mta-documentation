...
* You configured the Visual Studio Code IDE settings. For more information, see xref:configuring-lighstspeed-ide-settings_vsc-extension-guide[Configuring the {mta-dl-plugin} IDE settings].
