...
. In settings (image:settings-icon.png[settings-icon]), click *Configure Hub Settings*.
...
You can either use the web console username and password or the OpenID Connect (OIDC) credentials for authentication.
