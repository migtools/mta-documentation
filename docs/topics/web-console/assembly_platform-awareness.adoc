...
Before you import applications in {ProductShortName}, you can discover them  by using a combination of the organization, spaces, and application configurations.
