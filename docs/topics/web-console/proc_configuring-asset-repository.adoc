...
[role="_abstract"]
{ProductFirstRef} generates assets and publishes them to an asset repository that you configure. If you do not configure an asset repository, the application repository is taken as the default to publish the generated assets.
