...
You can filter application manifests in the CF clusters by organizations and spaces. 
...
. In the {ProductShortName} user interface, select the *Administration* working view.
